...
async function searchProvince(term, app) {
    ...
    const rdata = await ky.get('https://provinces.open-api.vn/api/p/search/', {
...
async function searchDistrict(term, provinceCode, app) {
    ...
    const rdata = await ky.get('https://provinces.open-api.vn/api/d/search/', {
...
async function searchWard(term, districtCode, app) {
    ...
    const rdata = await ky.get('https://provinces.open-api.vn/api/w/search/', {
